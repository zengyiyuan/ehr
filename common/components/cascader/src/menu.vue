...
export default {
  ...
  methods: {
    ...
    handleMenuEnter() {
      this.$nextTick(() =>
        this.$refs.menus.forEach(menu => this.scrollMenu(menu))
      );
    }
  },
  ...
  render(h) {
    ...
    const menus = this._l(activeOptions, (menu, menuIndex) => {
      ...
      const isHoveredMenu =
        expandTrigger === "hover" && activeValue.length - 1 === menuIndex;
    ...
    return (
      ...
      >
        ...
        >
          <div class="opt-group">
            <el-button type="default" onClick={this.reset} size="small">
              取消
            </el-button>
            <el-button type="primary" onClick={this.ok} size="small">
              确定
            </el-button>
          </div>
